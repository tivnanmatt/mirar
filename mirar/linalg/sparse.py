...
class ColSparseMatrixOperator(MatrixOperator):
    def __init__(self, input_shape, output_shape, indices, weights):
        ...
        super(ColSparseMatrixOperator, self).__init__(input_shape, output_shape)
...
class RowSparseMatrixOperator(MatrixOperator):
    """
    ...
    """
    def __init__(self, input_shape, output_shape, indices, weights):
        super(RowSparseMatrixOperator, self).__init__(input_shape, output_shape)
        assert indices.shape == weights.shape, "Indices and weights must have the same shape."
        self.indices = indices
        self.weights = weights
