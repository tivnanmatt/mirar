...
from .sparse import ColSparseMatrixOperator

class NearestNeighborInterpolator(ColSparseMatrixOperator):
    def __init__(self, num_row, num_col, interp_points):
        ...
        It inherits from the ColSparseMatrixOperator class.
...
class BilinearInterpolator(ColSparseMatrixOperator):
    def __init__(self, num_row, num_col, interp_points):
...
class LanczosInterpolator(ColSparseMatrixOperator):
